export const DragonIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ height: 50, width: 50 }}>
      <defs>
        <radialGradient id="delapouite-spiked-dragon-head-gradient-0">
          <stop offset="0%" stopColor="#2f3b3b" stopOpacity="1"></stop>
          <stop offset="100%" stopColor="#2f3b3b" stopOpacity="1"></stop>
        </radialGradient>
      </defs>
      <polygon
        points="415.81,415.81,256,482,96.19,415.81,30,256,96.19,96.19,256,30,415.81,96.19,482,256"
        fill="url(#delapouite-spiked-dragon-head-gradient-0)"
        stroke="#1c2224"
        strokeOpacity="1"
        strokeWidth="30"></polygon>
      <g transform="translate(20,-5)">
        <path
          ...
          fill="#000"
          fillOpacity="1"
          transform="translate(128, 128) scale(0.5, 0.5) rotate(0, 256, 256) skewX(0) skewY(0)"></path>
      </g>
    </svg>
  );
};
