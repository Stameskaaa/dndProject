  ...
  return (
    <svg
      ...
      <defs>
        ...
        <linearGradient id="delapouite-spiked-dragon-head-gradient-0">
          <stop offset="0%" stopColor="#7f9a89" stopOpacity="1"></stop>
      ...
      <circle
        ...
        cy="256"
        r="256"
        fill="url(#delapouite-spiked-dragon-head-gradient-0)"></circle>
