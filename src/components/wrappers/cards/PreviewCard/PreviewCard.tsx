  ...
  return (
    <div
      ...
      className={classNames(
        'w-full flex-1 h-[320px] group hover:scale-105 hover:z-1 transition-all hover:border-brand-100 relative cursor-pointer duration-500 border-1 border-brand-400',
        className,
      )}>
