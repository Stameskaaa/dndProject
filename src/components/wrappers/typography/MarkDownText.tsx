    ...
    <div className="prose prose-gray max-w-none">
      <ReactMarkdown
        components={{
          ...
          h1: ({ node, ...props }) => <h1 className="text-4xl text-text-primary my-4" {...props} />,
          h2: ({ node, ...props }) => <h2 className="text-3xl text-text-primary my-3" {...props} />,
          h3: ({ node, ...props }) => <h3 className="text-2xl text-text-primary my-2" {...props} />,
          h4: ({ node, ...props }) => <h4 className="text-xl text-text-primary my-1" {...props} />,
          h5: ({ node, ...props }) => (
            <h5 className="text-lg text-text-primary my-[6px]" {...props} />
          ),
          h6: ({ node, ...props }) => (
            <h6 className="text-base text-text-primary my-[4px]" {...props} />
          ),
          hr: ({ node, ...props }) => (
          ...
          th: ({ node, ...props }) => <th className="px-3 py-2  text-text-primary" {...props} />,
          td: ({ node, ...props }) => (
          ...
          img: ({ node, ...props }) => (
            <span className="m-4">
              <img
                className="max-h-[400px] rounded-lg shadow-black shadow-md"
                alt="Картинка"
                {...props}
              />
            </span>
